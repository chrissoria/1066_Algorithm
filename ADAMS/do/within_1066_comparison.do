...
drop if inlist(pid, 1109201, 1300101, 1300901, 1312101, 1316301, 1316302, 1620901, 2026501, 2040901, 2046001, 2046002, 2066101, 2070001, 2070302, 2583601)
    ...
    replace countryid = 3 if householdcountry == "Peru"
    replace countryid = 4 if householdcountry == "Venezuela"
    replace countryid = 5 if householdcountry == "Mexico"
...
foreach dem_var in cdem1066 cdem1066pred50 {
        qui: logit `dem_var' ib2.educat age agesq
